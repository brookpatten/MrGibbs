		...
		private void InitializeViewer ()
		{
			...
			if (_lineStateMaps == null) {
				...
				*/
				...
				_lineStateMaps.Add (StateValueMap(StateValue.CourseOverGroundDirection, "Course Over Ground",format:"{0:D0}"));
				_lineStateMaps.Add (StateValueMap(StateValue.MagneticHeading, "Heading (Mag)",format:"{0:D0}"));
				_lineStateMaps.Add (StateValueMap(StateValue.MagneticHeadingWithVariation, "Heading (True)",format:"{0:D0}"));
				_lineStateMaps.Add (StateValueMap(StateValue.Heel, "Heel",format:"{0:D0}"));
				...
				_lineStateMaps.Add (StateValueMap(StateValue.ApparentWindAngle, "Wind Direction (Aparant)",format:"{0:D0}"));
				_lineStateMaps.Add (StateValueMap(StateValue.TrueWindAngle, "Wind Direction (True)",missing:"?",format:"{0:D0}"));
				_lineStateMaps.Add (StateValueMap(StateValue.PeakSpeedInKnotsForWind, "Nominal Speed",missing:"?"));
				_lineStateMaps.Add (StateValueMap(StateValue.PeakSpeedPercentForWind, "% Nominal Speed",format:"{0:D0}%",missing:"?"));
				...
				_lineStateMaps.Add (StateValueMap(StateValue.VelocityMadeGoodPercent,"VMG %",format:"{0:D0}%",missing:"?"));
				_lineStateMaps.Add (StateValueMap(StateValue.VelocityMadeGoodOnCoursePercent,"VMC %",format:"{0:D0}%",missing:"?"));
				_lineStateMaps.Add (StateValueMap(StateValue.CurrentTackCourseOverGroundDelta, "Current Tack Delta",format:"{0:D0}"));
				_lineStateMaps.Add (StateValueMap(StateValue.CourseOverGroundRelativeToCourse, "Course Relative",format:"{0:D0}"));
				_lineStateMaps.Add (StateValueMap(StateValue.MastHeel, "Mast Heel",format:"{0:D0}"));
				_lineStateMaps.Add (StateValueMap(StateValue.MastPitch, "Mast Pitch",format:"{0:D0}"));
